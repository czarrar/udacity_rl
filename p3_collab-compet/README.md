...
2. View `Tennis.ipynb` file and follow the instructions.

### Relevant Files

* `maddpg.py`: Is the file with the Agent Class
* `model.py`: Is the PyTorch model file
* `Tennis.ipynb`: The notebook that runs the different variations on the agent
